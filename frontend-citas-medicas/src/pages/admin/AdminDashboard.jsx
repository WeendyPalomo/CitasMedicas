  ...
  return (
    <div className="max-w-4xl mx-auto p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Control de Citas y Médicos */}
        <Link to="/admin/reportes" className="p-6 bg-green-50 rounded-lg shadow hover:bg-green-100 transition">
          <h2 className="text-xl font-bold mb-2 text-green-800">Control de Citas y Médicos</h2>
          <p className="text-gray-700">Ver reportes e historial (en desarrollo).</p>
        </Link>
      </div>
    </div>
  );
